                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom_cliente" name="nom_cliente" placeholder="Nombre del cliente" require>
                            </div>
                            <div class="mb-3">
                                <label for="tipo_tarjeta" class="form-label">Tipo de tarjeta</label>
                                <input type="text" class="form-control" id="tipo_tarjeta" name="tipo_tarjeta" placeholder="Tipo de Tarjeta" require>
                            </div>
                            <div class="mb-3">
                                <label for="pago" class="form-label">Pago</label>
                                <input type="text" class="form-control" id="pago" name="pago" placeholder="Pago" require>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pais" name="pais" placeholder="Pais" require>
                            </div>
                            <div class="mb-3">
                                <label for="num_exterior" class="form-label">Numero exterior</label>
                                <input type="text" class="form-control" id="num_exterior" name="num_exterior" placeholder="Numero de la casa exterior" require>
                            </div>
