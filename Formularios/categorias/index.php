            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">Desarolladora</th>
                        <th scope="col">Fecha de salida</th>
                        <th scope="col">Cantidad del producto en fisico</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['desarolladora'] ?></th>
                            <th scope="row"><?php echo $resultado['fecha_salida'] ?></th>
                            <th scope="row"><?php echo $resultado['edi_fisicas'] ?></th>
                            <th scope="row"><?php echo $resultado['tip_prod'] ?></th>
                            <th scope="row"><?php echo $resultado['precio'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?Id=<?php echo $resultado['id_producto'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['id_producto'] ?>" class="btn btn-outline-danger">
