                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom_producto" name="nom_producto" placeholder="Nombre del producto" require>
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">Descripcion</label>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion" require>
                            </div>
                            <div class="mb-3">
                                <label for="desarolladora" class="form-label">Desarolladora</label>
                                <input type="text" class="form-control" id="desarolladora" name="desarolladora" placeholder="Nombre de la desarolladora" require>
                            </div>
                            <div class="mb-3">
                                <label for="fecha_salida" class="form-label">Fecha de lanzamiento</label>
                                <input type="date" class="form-control" id="fecha_salida" name="fecha_salida" placeholder="Fecha de salida" require>
                            </div>
                            <div class="mb-3">
                                <label for="edi_fisicas" class="form-label">Cantidades del producto en unidades fisicas</label>
                                <input type="text" class="form-control" id="edi_fisicas" name="edi_fisicas" placeholder="Cantidad de ediciones fisicas" require>
                            </div>
                            <div class="mb-3">
                                <label for="tip_prod" class="form-label">Tipo de producto</label>
                                <input type="text" class="form-control" id="tip_prod" name="tip_prod" placeholder="Tipo de producto" require>
                            </div>
                            <div class="mb-3">
                                <label for="precio" class="form-label">Precio</label>
                                <input type="text" class="form-control" id="precio" name="precio" placeholder="Precio" require>
                            </div>
